...
const DashboardSuperAdmin = () => {
  ...
  const totalCustomers = Array.isArray(users) ? users.filter(u => u.role === 'customer').length : 0;
        ...
        <div className="lg:col-span-2">
          <div className="card">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link to="/all-orders" className="text-sm text-primary-600 hover:text-primary-700 font-medium">
                View all
              </Link>
            </div>
        ...
        <div>
          <div className="card">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link to="/all-products" className="text-sm text-primary-600 hover:text-primary-700 font-medium">
                View all
              </Link>
            </div>
